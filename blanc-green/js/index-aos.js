function remove() {
  ...
  $(".headRight .hamberger").removeClass("black").addClass("white");
...
function add() {
  ...
  $(".headRight .hamberger").removeClass("white").addClass("black");
...
$(".headRight .hamberger").click(function () {
  ...
  //$(".headRight .hamberger").toggleClass("on");
  $(".headRight .hamberger > div").toggleClass("active");
  let hamnav = $(".hamNav");

  if (hamnav.css("visibility") === "hidden") {
