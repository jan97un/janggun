...
$(".close").click(function () {
  $(".nav899").css("display", "none");
  $("body").off("scroll touchmove mousewheel");
});
$(".nav899 .navBox li").click(function () {
  let i = $(this).index();
  console.log(i);
  if ($(".nav899 .navBox li").eq(i).find(".dep2").css("display") == "block") {
    $(".nav899 .navBox li").eq(i).find(".dep2").css("display", "none");
    $(".nav899 .navBox li").eq(i).find(".plus").css("display", "block");
    $(".nav899 .navBox li").eq(i).find(".minus").css("display", "none");
  } else {
    $(".nav899 .navBox li").eq(i).find(".dep2").css("display", "block");
    $(".nav899 .navBox li").eq(i).find(".plus").css("display", "none");
    $(".nav899 .navBox li").eq(i).find(".minus").css("display", "block");
  }
});
